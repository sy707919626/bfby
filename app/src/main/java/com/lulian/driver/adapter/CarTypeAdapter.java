...
public class CarTypeAdapter extends BaseAdapter {
    Context context;
    List<CarType> lines;
    public CarTypeAdapter(Context context, List<CarType> lines){
        this.context=context;
        this.lines=lines;
    }

    public void setData(List<CarType> lines){
        this.lines=lines;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHandler.item_txt_type.setText(lines.get(position).getText());
        return view;
    }
