...
import com.lulian.driver.adapter.OfferOrderListAdapter;
...
public class KnownOrderFragment extends BaseFragment{
    ...
    private OfferOrderListAdapter adapter;//列表数据适配器
    ...
    private void initView(){
        ...
        adapter = new OfferOrderListAdapter(getActivity());
    ...
    private BaseRvAdapter.OnChildClickListener listItemChildClickListener = new BaseRvAdapter.OnChildClickListener() {
        ...
        public void onClick(BaseRvAdapter adapter, View view, int position) {
            ...
            switch (view.getId()) {
                case R.id.iv_call://点击联系货主
                    ProjectUtil.checkCallPhone(mActivity,item.getPhone());
                    break;
